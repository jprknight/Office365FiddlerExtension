...
namespace Office365FiddlerExtension.Ruleset
{
    ...
    {        
        ...
        public void HTTP_218_This_Is_Fine_Apache_Web_Server(Session session)
        {
            ...
            GetSetSessionFlags.Instance.SetResponseCodeDescription(this.session, "218 This is fine (Apache Web Server)");

            GetSetSessionFlags.Instance.SetXResponseAlert(this.session, "HTTP 218 This is fine (Apache Web Server).");
