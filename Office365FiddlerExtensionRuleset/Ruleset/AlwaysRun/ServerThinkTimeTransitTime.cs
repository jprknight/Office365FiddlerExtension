...
namespace Office365FiddlerExtensionRuleset.Ruleset
{
    class ServerThinkTimeTransitTime
    {
        ...
        public void Run(Session session)
        {
            ...
            {
                TelemetryService.CustomTrackEvent("RS_ServerThinkTimeTransitTime");
                TelemetryService.CustomTrackMetric("RS_ServerThinkTimeTransitTime", sw.ElapsedMilliseconds);
            }
        }
    }
}
