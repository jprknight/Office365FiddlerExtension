...
namespace Office365FiddlerExtension.Services
{
    ...
    /// </summary>
    public class RulesetSessionFlagService
    {
        internal Session session { get; set; }

        private static RulesetSessionFlagService _instance;
        public static RulesetSessionFlagService Instance => _instance ?? (_instance = new RulesetSessionFlagService());
        ...
        public ExtensionSessionFlags GetDeserializedSessionFlags(Session Session)
        {
            ...
            try
            {
                return JsonConvert.DeserializeObject<RulesetSessionFlagService.ExtensionSessionFlags>(RulesetSessionFlagService.Instance.GetSessionJsonData(this.session));
            }
            catch (Exception ex)
            {
