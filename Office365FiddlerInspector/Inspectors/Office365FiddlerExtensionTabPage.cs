...
{ 
    public class Office365FiddlerExtensionTabPage : IFiddlerExtension
    {
        ...
        public void OnLoad()
        {
            ...
            if (!Preferences.ExtensionEnabled)
            {
                if (Preferences.DisableWebCalls)
                {
                    ...
                    TabPageResultsString.AppendLine(StrExtensionDisabled());
            ...
            else
            {
                if (Preferences.DisableWebCalls)
                {
                    ...
                    TabPageResultsString.AppendLine("<p>The columns the extension adds: Elapsed Time, Session Type, Authentication Host IP and Response Server.</p>");
                ...
                else
                {
                    ...
                    TabPageResultsString.AppendLine("<p>The columns the extension adds:</p>");
        ...
        {
            return "<p>To access the Inspector in the extension click the Inspectors tab.</p>";
        }
