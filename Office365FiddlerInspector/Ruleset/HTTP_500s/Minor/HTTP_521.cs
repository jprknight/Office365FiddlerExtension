...
namespace Office365FiddlerInspector.Ruleset
{
    class HTTP_521 : ActivationService
    {
        ...
        public void HTTP_521_Web_Server_Is_Down(Session session)
        {
            ...
            getSetSessionFlags.SetResponseCodeDescription(this.session, "521 Cloudflare Web Server Is Down");

            getSetSessionFlags.SetXResponseAlert(this.session, "HTTP 521 Cloudflare Web Server Is Down.");
