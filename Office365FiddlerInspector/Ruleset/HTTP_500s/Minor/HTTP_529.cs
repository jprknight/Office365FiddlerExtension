...
namespace Office365FiddlerInspector.Ruleset
{
    class HTTP_529 : ActivationService
    {
        ...
        public void HTTP_529_Site_Is_Overloaded(Session session)
        {
            ...
            getSetSessionFlags.SetResponseCodeDescription(this.session, "529 Site is overloaded");

            getSetSessionFlags.SetXResponseAlert(this.session, "HTTP 529 Site is overloaded.");
