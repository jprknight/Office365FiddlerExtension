...
namespace Office365FiddlerInspector.Ruleset
{
    class HTTP_527 : ActivationService
    {
        ...
        public void HTTP_527_Railgun_Error(Session session)
        {
            ...
            GetSetSessionFlags.Instance.SetResponseCodeDescription(this.session, "527 Cloudflare Railgun Error");

            GetSetSessionFlags.Instance.SetXResponseAlert(this.session, "HTTP 527 Cloudflare Railgun Error.");
