...
namespace Office365FiddlerInspector.Ruleset
{
    class HTTP_428 : ActivationService
    {
        ...
        public void HTTP_428_Precondition_Required(Session session)
        {
            ...
            getSetSessionFlags.SetResponseCodeDescription(this.session, "428 Precondition Required (RFC 6585)");

            getSetSessionFlags.SetXResponseAlert(this.session, "HTTP 428 Precondition Required (RFC 6585).");
