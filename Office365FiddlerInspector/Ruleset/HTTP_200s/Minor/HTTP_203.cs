...
namespace Office365FiddlerInspector.Ruleset
{
    class HTTP_203 : ActivationService
    {
        ...
        public void HTTP_203_NonAuthoritive_Answer(Session session)
        {
            ...
            getSetSessionFlags.SetResponseCodeDescription(this.session, "203 Non-Authoritative Information");

            getSetSessionFlags.SetXResponseComments(this.session, "203 Non-Authoritative Information");
